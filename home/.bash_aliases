...
alias lofi='mpv --no-video https://youtu.be/4xDzrJKXOOY'  # play lo-fi music; for more lofi logic, see this post: https://forums.freebsd.org/threads/useful-scripts.737/page-19#post-763045
alias pdx=plandex
alias lgit=lazygit
