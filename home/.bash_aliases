...
#alias charles='/data/progs/charles/charles'  # charles proxy (think fiddler); now installed from repo
alias rambox='/data/progs/rambox/rambox'  # franz open-source alternative
alias nvim='/data/progs/neovim/nvim.appimage'  # only use this alias when using nvim via an AppImage
